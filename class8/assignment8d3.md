# Class 8: Reporting on government data
...
Finish the chart on your own and submit a markdown file with link to the project in Github, submitting the github link in Canvas.
