...
Work with Randy to understand the use of index/match. In preparation for that, download the most recent COVID case data from Johns Hopkins by state and state population estimates (2018) from the Census.
