...
1. Create a Github account. Add your account name to the class Slack channel #digitalframewwork so I know where to find your homework.
1. Create a repository called *digitalframeworks-spring2020*. You will submit all your homework there.
...
2. Critique the story [following this template](https://github.com/randyleonard99/digitalframeworks-spring2020/blob/master/critique_template.md) in your markdown file. Include a hyperlink (written as 
